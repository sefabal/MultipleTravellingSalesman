...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IntStream.range(0, 500_000).boxed().parallel().forEach((t) -> {
            ...
            final int cost = edu.anadolu.mTSP.cost(mTSP.getDepots());
...
//        AtomicReference<MoveOperations> moveOperations = new AtomicReference<>();
//        moveOperations.set(new MoveOperations(best.get().getDepots()));
//
//        Random randoms = new Random();
//        randoms.ints(1_000_000,0,4).boxed().parallel().forEach(random -> {
//            if (random == 0)
//                moveOperations.get().swapNodesInRoute();
//            else if (random == 1)
//                moveOperations.get().swapHubWithNodeInRoute();
//            else if (random == 2)
//                moveOperations.get().swapNodesBetweenRoutes();
//            else if (random == 3)
//                moveOperations.get().insertNodeInRoute();
//            else if (random == 4)
//                moveOperations.get().insertNodeBetweenRoutes();
//        });
